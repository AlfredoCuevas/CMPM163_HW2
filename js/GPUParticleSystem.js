 ...
 *
 */
 /* Edit made in the last line of the FragmentShader by Alfredo Cuevas, The color doesn't seem to be working so I just hard coded it in*/
...
THREE.GPUParticleSystem = function ( options ) {
	...
	var GPUParticleShader = {
		...
		fragmentShader: [
			...
			'   gl_FragColor = vec4( vec3(0.15, 0.01, 0.01) * tex.a, alpha * tex.a ); // Alfredo Code;',
